...
class ElementsKit_Widget_Funfact extends Widget_Base {
	...
	protected function render_raw() {
		...
		$this->add_render_attribute('funfact_wrapper', 'class', 'elementskit-funfact' . ' text-' .'  ' . $enable_border_bottom . ' ' . $modern_design . ' ' . $hover_border_bottom_direction . ' ' . $divider_funfact . ' ' . $vertically_devider_position);
